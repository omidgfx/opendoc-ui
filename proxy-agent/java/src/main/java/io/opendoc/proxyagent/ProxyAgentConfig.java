...
public record ProxyAgentConfig(
    ...
    public static ProxyAgentConfig fromEnvironment() {
        return new ProxyAgentConfig(
                ...
                !"false".equalsIgnoreCase(valueOr(System.getenv("OPENDOC_PROXY_ENABLED"), "true").trim()));
    }
