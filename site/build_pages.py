  ...
  <div class="container">
    ...
    <div class="card-grid">
      ...
      <div class="info-card reveal d2" id="themes">
        ...
        <p>17 hand-picked palettes with per-spec memory and light / dark / system modes. Notes, badges and code views stay legible in every one — pick them from Settings.</p>
      </div>
...
npm run dev        <span class="c"># development server on :3000</span></div>
      ...
      <div class="doc-sec prose" id="themes">
        ...
        <p>Choose from 17 hand-picked palettes in the <b>Settings → Appearance</b> gallery (the old theme-only modal is gone); light, dark and system modes apply on top. The choice is remembered per specification, so each API keeps its own look. Notes, method badges and code views stay legible in every combination.</p>
      </div>
