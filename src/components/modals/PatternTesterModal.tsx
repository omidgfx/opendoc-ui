...
export default function PatternTesterModal({pattern, onClose}: PatternTesterModalProps) {
    ...
    return (<div className={`${backdropClassName} fixed inset-0 z-[9999] backdrop-blur-[2px]`}
                 style={{backgroundColor: 'rgba(0,0,0,0.5)'}} onClick={requestClose}>
        ...
        <div
            ...
            <div className="p-6 space-y-4 text-xs font-sans">
                ...
                <div className="space-y-1.5">
                    ...
                    <input id="regex-test-input" type="text" autoFocus placeholder="Type a value to test…"
