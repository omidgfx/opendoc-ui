...
function MiniPagePreview({palette, mode, roomy = false}: {
    palette: ThemeItem;
    mode: 'light' | 'dark';
    roomy?: boolean
}) {
        ...
        <div
            ...
            <div className="flex items-center justify-between border-b"
                ...
                <span className="font-bold uppercase tracking-widest"
                      style={{fontSize: roomy ? 8 : 5.5, color: palette.textMuted}}>{mode}</span>
            </div>
                ...
                <div className="flex-1" style={{padding: roomy ? 12 : 6}}>
                    ...
                    <div className="rounded border" style={{
                        ...
                        <div className="flex items-center gap-1.5" style={{marginBottom: roomy ? 10 : 5}}>
                            <span className="rounded font-black" style={{
...
function ThemePreviewCard({theme, selected, resolvedThemeMode, onSelect}: {
    theme: AppTheme;
    selected: boolean;
    resolvedThemeMode: 'light' | 'dark';
    onSelect: () => void
