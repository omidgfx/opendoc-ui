                ...
                <header
                    ...
                    <div className="flex min-w-0 items-center gap-3"><span
                        ...
                        <div className="min-w-0"><h3
                            ...
                            Authentication</h3><p
                            className="mt-0.5 truncate text-[10px] text-[var(--text-muted)]">Security scheme IDs and
                        ...
                        return <div key={id}
                            ...
                            {(credential.type === 'bearer' || credential.type === 'oauth2' || credential.type === 'openIdConnect') &&
                                <label className="block space-y-1"><span
                                    ...
                                    token</span><input type="password" className={fieldClass}
                            ...
                            {credential.type === 'basic' &&
                                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2"><label
