    ...
    return (
        <div className="flex h-full min-h-0 relative">
            ...
            <aside
                ...
                aria-label="Themes"
            >
                <div className="px-2 pb-2 pt-1 text-[9px] font-black uppercase tracking-[0.18em] text-[var(--text-muted)]">
                    All themes · {THEME_LIST.length}
                </div>
                <div className="space-y-1">
                    {THEME_LIST.map(theme => {
                ...
                <div className="mb-4 flex items-center justify-between gap-3">
                    <div className="flex items-center gap-2 min-w-0">
                        <div className="min-w-0">
                            ...
                            <h2 className="mt-1 text-base sm:text-lg font-extrabold truncate text-[var(--text-heading)]">
                                {selectedTheme.name}
                            </h2>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        />
                        Active in {currentThemeMode === 'system' ? `system (${resolvedThemeMode})` : currentThemeMode}{' '}
                        mode
                    </span>
                </div>
