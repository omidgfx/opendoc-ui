...
export default function MethodColorsPreview({ palette, roomy = false }: {
    palette: ThemeItem;
    roomy?: boolean;
}) {
    return (<div className="h-full overflow-hidden rounded-lg border" style={{ padding: roomy ? 16 : 10, backgroundColor: palette.surface, borderColor: palette.border }}>
            ...
            return (<span key={method.label} className="inline-flex items-center justify-center rounded-md border font-black tracking-wide" style={{
