...
export default function ThemeIdentityPanel({ theme, mode }: {
    theme: AppTheme;
    mode: 'light' | 'dark';
}) {
    ...
    return (<div className="relative min-h-[190px] overflow-hidden rounded-2xl border p-4 sm:p-5" style={{
            ...
            <div className="relative mt-5 grid grid-cols-2 gap-2">
                {colors.map((color) => <div key={color.label} className="flex items-center gap-2 rounded-lg border px-2.5 py-2" style={{ backgroundColor: alpha(palette.background, 'b8'), borderColor: palette.border }}>
