...
export default function ConfirmModal({
    ...
    if (!transition.shouldRender)
        return null;
    return <div className={`${transition.backdropClassName} fixed inset-0 z-[5000] bg-black/50 backdrop-blur-[2px]`}
        onMouseDown={event => {
        ...
        <div className="modal-surface modal-confirm-surface w-full max-w-sm overflow-hidden rounded-2xl border border-[var(--border)] bg-[var(--surface)] shadow-2xl">
            ...
            <div className="flex justify-end gap-2 bg-[var(--background)] px-5 py-3">
                <button type="button" onClick={transition.requestClose}
                ...
                <button type="button" onClick={() => {
                    ...
                    className={`rounded-lg px-4 py-2 text-xs font-bold cursor-pointer ${destructive
