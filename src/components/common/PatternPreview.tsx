...
export default function PatternPreview({pattern, onTest, showLabel = false, className}: PatternPreviewProps) {
    return (
        <div
            className={clsx(
                'flex max-w-full min-w-0 items-center gap-2 overflow-hidden py-1 text-[9px] font-mono',
                className,
            )}
        >
            ...
            >
                <code className="inline-block w-auto min-w-0 max-w-[160px] truncate overflow-hidden whitespace-nowrap text-ellipsis text-[var(--method-put)]">
                    /{pattern}/
                </code>
            </Tip>
            {onTest && (
