...
export default function TemperatureSlider({value, onChange}: TemperatureSliderProps) {
    ...
    return (<div className="rounded-xl border border-[var(--border)] bg-[var(--background)] px-3 py-3">
        <div role="slider" aria-label="Temperature" aria-valuemin={0} aria-valuemax={2} aria-valuenow={value}
             tabIndex={0} className="relative h-7 cursor-pointer touch-none select-none" onPointerDown={event => {
