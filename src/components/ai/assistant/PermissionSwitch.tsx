...
export default function PermissionSwitch({
    ...
    return (<button type="button" role="switch" aria-label={label} aria-checked={checked} onClick={onChange}
        ...
        <span aria-hidden="true" className="absolute size-5 rounded-full bg-white shadow-md transition-transform"
