            ...
            <div key={nodePath} className="space-y-0.5 animate-in fade-in duration-150">
                <button onClick={() => toggleNode(nodePath)}
                    ...
                    <span className="flex items-center gap-1.5 min-w-0">
                        ...
                        <span
                            className="text-[9px] font-mono px-1.5 py-0.5 rounded-full bg-[var(--text)]/10 text-[var(--text)]/80">{total}</span>
                    </span>
                </button>
                {!collapsed && (
                                ...
                                <Tip key={`${ep.method}-${ep.path}`} content={summary} placement="right">
                                    <button
                                        ...
                                        <div className="flex items-center gap-1.5 min-w-0 w-full">
                                            ...
                                            <span
                                                className={clsx('min-w-0 grow text-[11px] truncate', ep.operation?.deprecated && 'line-through opacity-70')}>{summary}</span>
                                            ...
                                            {ep.isProtected && <Tip content="Requires authentication"><i
