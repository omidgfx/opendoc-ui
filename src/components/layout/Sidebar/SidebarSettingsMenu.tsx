...
export default function SidebarSettingsMenu(props: SidebarSettingsMenuProps) {
    ...
    return <>
        {settingsMenuOpen && typeof document !== 'undefined' && createPortal(<div ref={settingsMenuRef} role="menu"
            ...
            <button type="button" role="menuitemcheckbox" aria-checked={sidebarConfig.displayRoutes} onClick={() => {
                ...
                <span
                    className={clsx('w-4 h-4 rounded border flex items-center justify-center shrink-0', sidebarConfig.displayRoutes ? 'bg-[var(--primary)] border-[var(--primary)] text-[var(--primary-contrast)]' : 'border-[var(--border)] text-transparent')}>
            ...
            <button type="button" role="menuitemcheckbox" aria-checked={sidebarConfig.flattenTags} onClick={() => {
                ...
                <span
                    className={clsx('w-4 h-4 rounded border flex items-center justify-center shrink-0', sidebarConfig.flattenTags ? 'bg-[var(--primary)] border-[var(--primary)] text-[var(--primary-contrast)]' : 'border-[var(--border)] text-transparent')}>
                    <i className="ph ph-check text-[11px]"/>
                </span>
            </button>
            ...
            <button type="button" role="menuitemcheckbox" aria-checked={sidebarConfig.pagesFirst} onClick={() => {
                ...
                <span
                    className={clsx('w-4 h-4 rounded border flex items-center justify-center shrink-0', sidebarConfig.pagesFirst ? 'bg-[var(--primary)] border-[var(--primary)] text-[var(--primary-contrast)]' : 'border-[var(--border)] text-transparent')}>
                    <i className="ph ph-check text-[11px]"/>
                </span>
            </button>

            <button type="button" role="menuitemcheckbox" aria-checked={sidebarConfig.compactMethodNames}
                    onClick={() => {
                        closeAllSubmenus();
                ...
                <span
                    className={clsx('w-4 h-4 rounded border flex items-center justify-center shrink-0', sidebarConfig.compactMethodNames ? 'bg-[var(--primary)] border-[var(--primary)] text-[var(--primary-contrast)]' : 'border-[var(--border)] text-transparent')}>
                    <i className="ph ph-check text-[11px]"/>
                </span>
            </button>
            ...
            <div ref={folderBehaviorItemRef} className="relative" onMouseLeave={() => {
                ...
                <button type="button" role="menuitem" aria-haspopup="menu" aria-expanded={folderBehaviorMenuOpen}
                        onMouseEnter={() => {
                            if (!isMobile)
                ...
                {folderBehaviorMenuOpen && (<div role="menu" aria-label="Tag folder behavior"
                    ...
                    ]).map(option => (<button key={option.value} type="button" role="menuitemradio"
                                              aria-checked={sidebarConfig.folderBehavior === option.value}
                                              onClick={() => updateFolderBehavior(option.value)}
                                              className={clsx('w-full text-left px-3 py-2 text-[11px] flex items-start gap-2 transition-colors cursor-pointer hover:bg-[var(--surface-hover)]', sidebarConfig.folderBehavior === option.value ? 'text-[var(--primary)]' : 'text-[var(--text)]')}>
            ...
            <div ref={sortMenuItemRef} className="relative" onMouseLeave={() => {
                ...
                <button type="button" role="menuitem" aria-haspopup="menu" aria-expanded={sortMenuOpen}
                        onMouseEnter={() => {
                            if (!isMobile)
                                openSortMenu();
                        }} onClick={() => {
                ...
                {sortMenuOpen && (<div role="menu" aria-label="Sort API navigation"
                    ...
                    {([
                        ...
                        return (<button key={option.value} type="button" role="menuitemradio" aria-checked={selected}
                                        aria-disabled={disabled} disabled={disabled} onClick={() => {
                            if (!disabled) {
            ...
            <button type="button" role="menuitemcheckbox" aria-checked={sidebarConfig.hideEndpointCount}
                    onClick={() => {
                        closeAllSubmenus();
                ...
                <span
                    className={clsx('w-4 h-4 rounded border flex items-center justify-center shrink-0', sidebarConfig.hideEndpointCount ? 'bg-[var(--primary)] border-[var(--primary)] text-[var(--primary-contrast)]' : 'border-[var(--border)] text-transparent')}>
                    <i className="ph ph-check text-[11px]"/>
                </span>
            </button>

            <button type="button" role="menuitemcheckbox" aria-checked={sidebarConfig.hideProtectedIcon}
                    onClick={() => {
                        closeAllSubmenus();
                ...
                <span
                    className={clsx('w-4 h-4 rounded border flex items-center justify-center shrink-0', sidebarConfig.hideProtectedIcon ? 'bg-[var(--primary)] border-[var(--primary)] text-[var(--primary-contrast)]' : 'border-[var(--border)] text-transparent')}>
                    <i className="ph ph-check text-[11px]"/>
                </span>
            </button>

            <button type="button" role="menuitemcheckbox" aria-checked={sidebarConfig.hideDeprecatedEndpoints}
                    onClick={() => {
                        closeAllSubmenus();
                ...
                <span
                    className={clsx('w-4 h-4 rounded border flex items-center justify-center shrink-0', sidebarConfig.hideDeprecatedEndpoints ? 'bg-[var(--primary)] border-[var(--primary)] text-[var(--primary-contrast)]' : 'border-[var(--border)] text-transparent')}>
                    <i className="ph ph-check text-[11px]"/>
                </span>
            </button>
        </div>, document.body)}
