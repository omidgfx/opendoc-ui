...
export default function DescriptionTip({description}: {
    ...
    if (!description?.trim())
        return null;
    return (<Tip interactive variant="surface" closable
                 content={<div className="max-w-[300px]"><Markdown text={description}
                                                                   className="text-[11px] leading-relaxed"/>
                 </div>}>
        <button type="button" aria-label="Show field description"
