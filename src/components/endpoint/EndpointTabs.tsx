...
export const isViewTab = (tab: TabItem) =>
    tab.kind === 'home' || tab.kind === 'search' || tab.kind === 'schemas' || tab.kind === 'about' || tab.kind === 'assistant';
    ...
    return (
        <>
            <div
                ...
                >
                    {tabs.map((tab, index) => {
                        // Defensive guard against corrupt tab data from storage.
                        ...
                        return (
                            <Tip key={tab.id} content={viewTab ? tab.label : `${tab.method.toUpperCase()} ${tab.path}`}
                                 placement="bottom">
                                <div
                                    data-tab-id={tab.id}
                                    draggable
