                        ...
                        <div className={'flex justify-between'}>
                            ...
                            {useModal && (inspectName ?? schemaName) && (
                                <Tip content={`Inspect ${inspectName ?? schemaName} schema`}>
                                    <button type="button" onClick={() => onPushSchema(inspectName ?? schemaName!)}
                        ...
                        <td className="px-3 py-2.5 font-mono font-bold text-[var(--text-heading)] whitespace-nowrap">
                            <div className={'flex items-start gap-1'}>
                                ...
                                {isRequired && (<Tip content="Required field">
                                    <span
                                        className="text-[var(--method-delete)] leading-none -mt-0.5 font-semibold text-[16px] cursor-help">*</span>
                                </Tip>)}
                            </div>
                        </td>
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                {pattern &&
                                    <div className="text-[10px] font-mono flex items-center gap-1 mt-0.5">
                                        ...
                                        <button type="button" onClick={() => onTestPattern(pattern)}
                        ...
                        <td className="px-3 py-2.5 whitespace-nowrap">
                            <div className="flex flex-col gap-1.5">
                                {isComplexType && (<Tip content="Generate simulated example for this sub-schema">
                                    <button type="button" onClick={() => onViewExample(name, pVal)}
                        ...
                        <td className="px-3 py-2.5 leading-relaxed font-sans text-[var(--text)]">
                            ...
                            {pVal.externalDocs && pVal.externalDocs.url &&
                                <div className="mt-1.5">
                                    <a href={pVal.externalDocs.url} target="_blank" rel="noopener noreferrer"
                            ...
                            {pVal.enum &&
                                <div className="mt-1.5 flex flex-wrap gap-1 items-center">
                                    <span className="font-semibold text-[10px] text-[var(--text-muted)]">
                                        Enum:</span>
                                    {pVal.enum.map((vEnum: any) => <span key={vEnum}
