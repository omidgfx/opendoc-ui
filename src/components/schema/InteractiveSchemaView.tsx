...
import {effectiveAllOfSchema} from '../../utils/schema/combinators';
...
export default function InteractiveSchemaView({
    ...
    const unifiedAllOf = hasAllOf ? effectiveAllOfSchema(resolved, resolveReference) : null;
    ...
    const renderStandardSchema = (s: any) => {
        ...
        const recursive = schemaIsRecursive(resolvedS, resolveReference);
        return (
