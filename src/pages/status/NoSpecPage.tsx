    ...
    return (<div className="flex-1 h-full overflow-y-auto scrollbar-thin">
        <div className="min-h-full flex items-center justify-center p-6 select-none">
            <div className="w-full max-w-md flex flex-col items-center text-center">
                <span
                    className="relative flex size-16 items-center justify-center rounded-2xl border border-[var(--border)] bg-[var(--surface)] text-[var(--primary)] shadow-sm">
                    <i className="ph-fill ph-file-text text-[24px]"></i>
                    <span
                        className="absolute -right-1.5 -bottom-1.5 flex size-6 items-center justify-center rounded-full border bg-[var(--surface)] border-[var(--border)] text-[var(--text-muted)]">
