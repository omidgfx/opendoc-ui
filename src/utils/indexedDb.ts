/* Small promise-based IndexedDB adapter used for large persistent documents.
 * Every operation falls back cleanly when IndexedDB is unavailable (SSR,
 * private browsing policy, old WebViews); callers retain a localStorage path. */
